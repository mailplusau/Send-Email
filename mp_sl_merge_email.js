        ...
        if (!isNullorEmpty(templateId)) {
            ...
            if (!isNullorEmpty(templateId) && !isNullorEmpty(recType) && !
                ...
                if (templateId == 219) {
                    ...
                    var expInterest = '<a class=" " href="https://mailplus.com.au/shipping-portal-orientation/?custinternalid=' + recId + '&custname=' + companyname + '&email=' + contactEmail + '&phone=' + contactPhone + '&firstname=' + firstname + '" >Book a call</a>'
                ...
                if (templateId == 446) {
                    ...
                    var customerDetails = 'Customer Name: ' + entityid + ' ' + companyname
                    var customerAddressDetails = addr1 + ', ' + addr2 + ', ' + city + ' ' + state + ' - ' + zip + '</br>';
                    ...
                    emailHtml = emailHtml.replace(/nlemcustomeraddress/gi, customerAddressDetails);
                    emailHtml = emailHtml.replace(/nlemcustomernumber/gi, contactPhoneDetails);
                    emailHtml = emailHtml.replace(/nlemconfirmbutton/gi, expIntcustomerVisitederest);
                ...
                if (templateId == 447 || templateId == 452) {
                    ...
                    var customerDetails = 'Customer Name: ' + entityid + ' ' + companyname
                    var customerAddressDetails = addr1 + ', ' + addr2 + ', ' + city + ' ' + state + ' - ' + zip;
                ...
                if (templateId == 448) {
                    ...
                    var expIntcustomerVisitederest = '<a class="mcnButton" href="https://1048144.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=1881&deploy=1&compid=1048144&ns-at=AAEJ7tMQK1CXKofoAqhSFTybZKV_oS_pyu7tSRTCHQsWssxiF7A&custinternalid=' + recId + '" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;display: block;" target="_blank" title="">Confirm</a>';
                    ...
                    emailHtml = emailHtml.replace(/nlemcontactphone/gi, contactPhoneDetails);
                    emailHtml = emailHtml.replace(/nlemconfirmbutton/gi, expIntcustomerVisitederest);
                    emailHtml = emailHtml.replace(/nleminvoicestartdate/gi, billingstartdate);
                    emailHtml = emailHtml.replace(/nlemsalesrecordlastassigned/gi, salesRepDetailsName);
                ...
                if (templateId == 422) {
                    ...
                    var expInterest = '<a class="mcnButton " href="https://1048144.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=1840&deploy=1&compid=1048144&h=374970ce5575b3b56d7e&custinternalid=' + recId + '"  style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;display: block;" target="_blank" title="Book a call">Accept</a>';
