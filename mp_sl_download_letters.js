 ...
 * @Last Modified time: 2020-07-22 09:30:51
 *
 */
...
function downloadLetter(request, response) {
    if (request.getMethod() === "GET") {
        ...
        inlinehtml2 += '<br><br><table border="0" cellpadding="15" id="customer" class="display tablesorter table table-striped table-bordered table-responsive" cellspacing="0"><thead style="color: white;background-color: #607799;"><tr><th class="text-center">ID</th><th class="text-center">Customer</th><th>URL</th></tr></thead>';
        ...
        // do {
        var resultCustomerSlice = resultSetCustomer.getResults(0, (slice_index + 1) * 65);
        nlapiLogExecution('DEBUG', 'resultCustomerSlice length', resultCustomerSlice.length)
        ...
        resultCustomerSlice.forEach(function(searchResult) {
            ...
            inlinehtml2 += '<tr><input type="hidden" class="form-control customer_id text-center" value="' + custid + '"><th>' + entityid + '</th><th>' + companyname + '</th><th><a class="letter_download" href="' + url2 + '" download>DOWNLOAD</a></th></tr>'
