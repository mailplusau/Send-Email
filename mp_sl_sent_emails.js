...
function sendEmails(request, response) {
    if (request.getMethod() == "GET") {
        ...
        if (!isNullorEmpty(params)) {
            ...
            letter_type = request.getParameter('custparam_letter_type');
            ...
            pdf = request.getParameter('custparam_pdf');
        }
        ...
        form.addField('custpage_letter_type', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(letter_type);
        ...
        form.addField('custpage_pdf', 'text', 'Customer ID').setDisplayType('hidden').setDefaultValue(pdf);
