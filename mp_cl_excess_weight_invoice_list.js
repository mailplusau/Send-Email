...
function pageInit() {
    ...
    //     dataSet += '{"inv_internal_id":"' + invoiceInternalId + '","inv_doc_no":"' + documentNumber + '","inv_date":"' + invoiceDate + '","inv_date_from":"' + invocieDateFrom + '","inv_date_to":"' + invoiceDateTo + '","cust_id":"' + invoiceCustomerInternalId + '", "entityid":"' + invoiceCustomerId +
    //         '", "companyname_text":"' + invoiceCustomerCompanyName + '"},';
    ...
    $(document).ready(function () {
        ...
        //             return '<p><b>' + data.inv_doc_no + '</b></p><input type="hidden" class="form-control customer_id text-center" value="' +
        //             data.inv_internal_id + '">';
        //         }
        //     },{
        //         "data": null,
        //         "render": function (data, type, row) {
        //             return '<p><b>' + data.inv_date + '</b></p>';
        //         }
        //     },{
        //         "data": null,
        //         "render": function (data, type, row) {
        //             return '<p><b>' + data.inv_date_from + '</b></p>';
        //         }
        //     },{
        //         "data": null,
        //         "render": function (data, type, row) {
        //             return '<p><b>' + data.inv_date_to + '</b></p>';
        //         }
        //     },{
        //         "data": null,
        //         "render": function (data, type, row) {
        ...
        resultSetExcessWeightInvoiceEmailSearch.forEachResult(function (searchResult) {
            ...
            debt_set2.push({
                inv_internal_id: invoiceInternalId,
                inv_doc_no: documentNumber,
                inv_date: invoiceDate,
                inv_date_from: invocieDateFrom,
                inv_date_to: invoiceDateTo,
                cust_id: invoiceCustomerInternalId,
                entityid: invoiceCustomerId,
                companyname_text: invoiceCustomerCompanyName,
            });
        ...
        if (!isNullorEmpty(debt_set2)) {
            debt_set2.forEach(function (debt_row2, index) {
                ...
                var linkURL = '<input type="button" id="" data-id="' +
                    debt_row2.inv_internal_id +
                    '" value="VIEW INVOICE" class="form-control btn btn-xs btn-primary salesrepassign" style="color: black; cursor: pointer !important;width: fit-content;" />';

                var customerIDLink =
                    '<a href="https://1048144.app.netsuite.com/app/common/entity/custjob.nl?id=' +
                    debt_row2.cust_id + '&whence=" target="_blank"><b>' +
                    debt_row2.entityid + '</b></a>';


                var invoiceIdLink =
                    '<a href="https://1048144.app.netsuite.com/app/accounting/transactions/custinvc.nl?id=' +
                    debt_row2.inv_internal_id + '&whence=" target="_blank"><b>' +
                    debt_row2.inv_doc_no + '</b></a>';
                ...
                debtDataSet.push([invoiceIdLink, debt_row2.inv_date, debt_row2.inv_date_from, debt_row2.inv_date_to, customerIDLink, debt_row2.companyname_text
                ]);
            });
        }
